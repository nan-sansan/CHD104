...
$(document).ready(function(){
    var headlineNews  = [
        {link:"#",pic:"#",title:"環保里程碑 🌱",content:"12312345"},
        {link:"#",pic:"#",title:"環保里程碑 🌱",content:"12312345"},
        {link:"#",pic:"#",title:"雙十一狂歡季，大大大優惠，探索簡約之美，限時特價！",content:"很長的文字的測試用，贏得限量好禮。成為我們社群的一部分！參與我們的線上活動，贏得限量好禮。成為我們社群的一部分！參與我們的線上活動，贏得限量好禮。成為我們社群的一部分！參與我們的線上活動，贏得限量好禮。"},
        {link:"#",pic:"#",title:"環保里程碑 🌱",content:"12312345"},
        {link:"#",pic:"#",title:"環保里程碑 🌱",content:"12312345"},
        {link:"#",pic:"#",title:"環保里程碑 🌱",content:"12312345"},
        {link:"#",pic:"#",title:"環保里程碑 🌱",content:"12312345"},
    ...
    var featuredList = [
        ...
        {link:"#",pic:"#",name:"魂牽夢縈",price:"999",content:"12312345"},
        {link:"#",pic:"#",name:"魂牽夢縈",price:"999",content:"12312345"},
        {link:"#",pic:"#",name:"魂牽夢縈",price:"999",content:"極致純淨，空間中的一抹雅致之選。如水晶一般晶瑩剔透，完美呈現花卉之美。<br><br>簡約的設計融入現代生活，使得這個花瓶不僅是裝飾品，更是一種生活態度。<br><br>適合放置於任何角落，它能為家居帶來清新自然的氛圍，成為每日生活中的一抹亮色。精湛工藝、獨特造型，每個花瓶都是一件獨一無二的藝術品。選擇我們的花瓶，將自然之美注入居家空間，讓您的生活更加美好。 <br><br>"}
    ];
