...
$(document).ready(function(){
    var headlineNews  = [
        {link:"newspage.html",pic:"material/winter.png",title:"溫暖寒冬，將冷冽轉為溫馨。",content:"陪伴您度過這個冬天，將寒冷的季節化為充滿愛與溫馨的冬日風情。立即探索我們的線上商店，挑選出冬日暖心系列的精品，讓您的冬天更加溫馨美好。"},
        {link:"newspage.html",pic:"material/celSmall.png",title:"慶周年，滿額贈好禮！",content:"隆重慶祝周年，感謝您一路的支持與厚愛。為了回饋您的支持，我們特別推出了滿額贈好禮的精彩活動！"},
    ...
    var featuredList = [
        {link:"#",pic:"material/pillow.jpg",name:"魂牽夢縈",price:"999",content:"12312345"},
